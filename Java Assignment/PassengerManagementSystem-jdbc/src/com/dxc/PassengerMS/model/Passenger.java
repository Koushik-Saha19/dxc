package com.dxc.PassengerMS.model;
...
public class Passenger {
	...
	public String getPassengertName() {
		return passengerName;
	}

	public void setPassengertName(String passengerName) {
	...
	public String toString() {
		return "Passenger [passengerPNR=" + passengerPNR + ", passengertName=" + passengerName + ", source=" + source
